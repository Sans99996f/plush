document.addEventListener('DOMContentLoaded', () => {
  ...
  // Обработчик кнопки Checkout (заглушка)
  if (cartCheckout) {
  ...
  console.log(" - Проверить существование элементов: document.querySelector('.products'), document.querySelector('.pagination-wrapper .pagination'), document.querySelector('.cart-modal')");
  console.log(" - Если пагинация или корзина не видны — откройте DevTools (F12) и посмотрите ошибки/лог.");
});